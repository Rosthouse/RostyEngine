...
public class RenderSystem extends EntitySystem implements EntityListener {
    ...
    public void addedToEngine(Engine engine) {
        ...
        spriteEntites = engine.getEntitiesFor(Family.getFor(ComponentType.getBitsFor(PositionComponent.class), ComponentType.getBitsFor(RenderComponent.class, PolygonComponent.class), ComponentType.getBitsFor()));
    ...
    public void update(float deltaTime) {
        ...
        for (int i = 0; i < this.spriteEntites.size(); i++) {
            ...
            RenderComponent cpRender = cmRender.get(spriteEntites.get(i));
